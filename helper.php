...
class modSPImageSliderHelper
{
  ...
  //
	...
	// 	$css3transition = $params->get('css3') ? modSPImageSliderHelper::getCSS3Transition($transition, $easing) : '';
  //
	...
	// 		$transition = modSPImageSliderHelper::getMooTransition($transition);
